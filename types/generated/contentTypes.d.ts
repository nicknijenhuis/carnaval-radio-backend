...
export interface ApiSponsorTypeSponsorType extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Order: Attribute.Integer & Attribute.DefaultTo<0>;
    LogoSize: Attribute.Enumeration<['S', 'M', 'L', 'XL', 'XXL']> &
      Attribute.Required &
      Attribute.DefaultTo<'L'>;
    ShowOnHomePage: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<true>;
    ShowAudioPlayerFixed: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    ShowAudioPlayerRotating: Attribute.Boolean;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::sponsor-type.sponsor-type',
...
export interface ApiThemeTheme extends Schema.SingleType {
  ...
  attributes: {
    ...
    Primary: Attribute.String &
      Attribute.CustomField<'plugin::color-picker.color'>;
    PrimaryShade_1: Attribute.String &
      Attribute.CustomField<'plugin::color-picker.color'>;
    PrimaryShade_2: Attribute.String &
      Attribute.CustomField<'plugin::color-picker.color'>;
    PrimaryShade_3: Attribute.String &
      Attribute.CustomField<'plugin::color-picker.color'>;
    Secondary: Attribute.String &
      Attribute.CustomField<'plugin::color-picker.color'>;
    SecondaryShade_1: Attribute.String &
      Attribute.CustomField<'plugin::color-picker.color'>;
    SecondaryShade_2: Attribute.String &
      Attribute.CustomField<'plugin::color-picker.color'>;
    HeroBackground: Attribute.String &
      Attribute.CustomField<'plugin::color-picker.color'>;
    SideBarBackground: Attribute.String &
      Attribute.CustomField<'plugin::color-picker.color'>;
    ActiveTab: Attribute.String &
      Attribute.CustomField<'plugin::color-picker.color'>;
    Tertiary: Attribute.String &
      Attribute.CustomField<'plugin::color-picker.color'>;
    TertiaryShade_1: Attribute.String &
      Attribute.CustomField<'plugin::color-picker.color'>;
    TertiaryShade_2: Attribute.String &
      Attribute.CustomField<'plugin::color-picker.color'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
